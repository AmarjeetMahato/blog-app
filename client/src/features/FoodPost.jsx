       ...
       <div className="">
          <div className="posts mt-[50px] flex flex-col gap-10">
                  <div className="flex items-center justify-between gap-1">
                      <h1 className="text-[20px]  md:text-[30px] font-semibold uppercase border-b border-red-500 w-max">Food Post</h1>
                      <Link to="/food" className="flex items-center gap-1">See all</Link>
                  </div>
